...
![Android base class load](images/android_base_class_load.png "Android base class load")
...
![Base dex class loader](images/base_dex_class_loader.png "Base dex class loader")
...
![ClassLinker load class dependent](images/classlinker_load_class_dependent.png "ClassLinker load class dependent")
...
第二步，用 javac 命令将该类编译成字节码文件，然后用 dx 工具将字节码文件打包成 .dex 文件。
